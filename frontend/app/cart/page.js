                                                ...
                                                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                                    ...
                                                    <div className="flex items-center justify-between md:order-3 md:justify-end">
                                                        <div className="flex item-center">
                                                            ...
                                                            <input type="text" id="counter-input" data-input-counter className="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 " placeholder="" value={productItem.quantity} required/>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <dl className="flex items-center justify-between gap-4">
                                            ...
                                            {/* <dd className="text-base font-medium text-gray-900">{cartDetails.totalPrice}</dd> */}
                                        </dl>
